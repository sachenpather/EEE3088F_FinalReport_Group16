...
\begin{figure}
    ...
    \label{fig:schematic}
\end{figure}
    %\includegraphics[width=0.5\linewidth]{EEE3088F_latex_template-2/Figures/Final_Schematic.jpg}
    % \caption{Schematic}
    % \label{fig:schematic}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.3\linewidth}
        \begin{figure}
            ...
            \label{fig:PCB_Front}
        \end{figure}
        %\includegraphics[width=1\linewidth]{EEE3088F_latex_template-2//Figures/signature.jpg}
       % \caption{Front PCB}
       % \label{fig:PCB_front}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.3\linewidth}
        \begin{figure}
            ...
            \label{fig:PCB_back}
        \end{figure}
       % \includegraphics[width=\linewidth]{EEE3088F_latex_template-2//Figures/signature.jpg}
        %\caption{Back PCB}
        %\label{fig:PCB_back}
    \end{subfigure}
    \hfill % Space between the subfigures
